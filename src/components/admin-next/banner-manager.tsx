      ...
      <div className="mx-auto" style={{ width: 380 }}>
        <div
          ...
          style={{
            ...
            boxShadow: "0 0 0 2px #3a3a3c, inset 0 0 0 2px #2c2c2e, 0 30px 60px rgba(0,0,0,0.65)",
          }}
        >
          {/* Notch */}
          <div className="absolute left-1/2 -translate-x-1/2 bg-[#1c1c1e]" style={{ top: 15, width: 135, height: 27, borderRadius: "0 0 20px 20px", zIndex: 10 }} />
          {/* Side buttons */}
