...
export async function GET(_: Request, context: RouteContext) {
  ...
  try {
    ...
    return NextResponse.json({ message: "ไม่สามารถดึงข้อมูลสมาชิกได้" }, { status: 503 });
  }
}
...
export async function PATCH(request: Request, context: RouteContext) {
  ...
  try {
    ...
    return NextResponse.json({ message: "ไม่สามารถแก้ไขสมาชิกได้" }, { status: 503 });
  }
}
...
export async function DELETE(_: Request, context: RouteContext) {
  ...
  try {
    ...
    return NextResponse.json({ message: "ไม่สามารถลบสมาชิกได้" }, { status: 503 });
  }
}
